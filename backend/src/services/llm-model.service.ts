// @ts-ignore
import { CreateLlmModelDTO, LlmModelDto, UpdateLlmModelDTO } from '../types/llm-model';
...
export class LlmModelService {
    ...
    static async updateModel(id: number, data: UpdateLlmModelDTO): Promise<LlmModelDto | null> {
